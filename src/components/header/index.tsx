  ...
  return (
    <>
      <ContainerHeader>
        ...
        <HeaderItemsWrapper>
          <LocalizeWrapper>
            <LocalizeButton onClick={() => handleLocalizeClick('ru')} active={activeLocalizeBtn === 'ru'}>
              ru
            </LocalizeButton>
            <LocalizeButton onClick={() => handleLocalizeClick('en')} active={activeLocalizeBtn === 'en'}>
              en
            </LocalizeButton>
          </LocalizeWrapper>
          <ProfileLink to={'#'}>Личный кабинет</ProfileLink>
